...
public class TankUtilities {
    public int MaximumCapacitance;
    public int liquidAmount;
    public String liquidName;

    public TankUtilities(int maximumCapacitance, int liquidAmount, String liquidName) {
    ...
    public boolean receiveLiquid(String liquidName, int liquidAmount){
