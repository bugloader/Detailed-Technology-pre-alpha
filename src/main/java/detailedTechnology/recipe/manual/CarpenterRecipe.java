...
public class CarpenterRecipe {
    ...
    public static final ArrayList<Boolean> dropTinders = new ArrayList<>();

    public void addRecipe(String toolName,int toolLevel,Item[] ingredients, int[] ingredientsNum, Item result, int resultNum,boolean dropTinder) {
    ...
    public CarpenterRecipe() {
        ...
        addRecipe("saw",1,new Item[]{Ores.bronzePlate},
                new int[]{1}, Materials.smallBronzePlate, 4,false);

        addRecipe("knife",0,new Item[]{Items.ACACIA_LOG},
                new int[]{1}, Items.STRIPPED_ACACIA_LOG,1,true);
        addRecipe("knife",0,new Item[]{Items.BIRCH_LOG},
                new int[]{1}, Items.STRIPPED_BIRCH_LOG,1,true);
        addRecipe("knife",0,new Item[]{Items.JUNGLE_LOG},
                new int[]{1}, Items.STRIPPED_JUNGLE_LOG,1,true);
        addRecipe("knife",0,new Item[]{Items.OAK_LOG},
                new int[]{1}, Items.STRIPPED_OAK_LOG,1,true);
        addRecipe("knife",0,new Item[]{Items.DARK_OAK_LOG},
                new int[]{1}, Items.STRIPPED_DARK_OAK_LOG,1,true);
        addRecipe("knife",0,new Item[]{Items.SPRUCE_LOG},
                new int[]{1}, Items.STRIPPED_SPRUCE_LOG,1,true);
