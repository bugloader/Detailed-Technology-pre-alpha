...
import detailedTechnology.blocks.machines.manual.blockEntity.FireStarterBlockEntity;
            ...
            if(player.isSneaking()) {
                ...
                if(inventory!=null&&inventory.getStack(0).getName().equals(Items.CHARCOAL.getName())) {
                    ...
                    if(blockName.equals(Blocks.STRIPPED_ACACIA_LOG.getName())||
                        ...
                        world.setBlockState(backPos, Auto.burningCharcoalHeap.getDefaultState());
                    }
                }
            } else {
