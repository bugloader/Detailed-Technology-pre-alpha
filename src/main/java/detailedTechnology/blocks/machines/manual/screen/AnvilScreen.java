...
public class AnvilScreen extends HandledScreen<ScreenHandler> {
    //A path to the gui texture. In this example we use the texture from the dispenser
    private static final Identifier TEXTURE = new Identifier("dt", "textures/gui/container/bronze_anvil.png");
    private AnvilScreenHandler screenHandler;
    public AnvilScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
        super(handler, inventory, title);
        screenHandler = (AnvilScreenHandler)handler;
    }
