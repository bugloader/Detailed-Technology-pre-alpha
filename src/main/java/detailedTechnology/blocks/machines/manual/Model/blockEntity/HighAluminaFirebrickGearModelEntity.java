...
public class HighAluminaFirebrickGearModelEntity extends BlockEntity implements ImplementedInventory, NamedScreenHandlerFactory, Tickable {
    ...
    public HighAluminaFirebrickGearModelEntity() {
        super(Manual.highAluminaFirebrickGearModelEntity);
