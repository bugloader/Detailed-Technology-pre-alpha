...
public class ClayPlateModelEntity extends BlockEntity implements ImplementedInventory, NamedScreenHandlerFactory, Tickable {
    ...
    public ClayPlateModelEntity() {
        super(Manual.clayPlateModelEntity);
        utilities = new ModelUtilities("plate");
        needInitialise = true;
    }
    ...
    private void checkBreak() {
        if (utilities.temperature > Materials.BRICK.getMeltingPoint()) {
