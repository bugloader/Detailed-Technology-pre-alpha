...
public class HighAluminaFirebrickIngotModelEntity extends BlockEntity implements ImplementedInventory, NamedScreenHandlerFactory, Tickable {
    ...
    public HighAluminaFirebrickIngotModelEntity() {
        super(Manual.highAluminaFirebrickIngotModelEntity);
        utilities = new ModelUtilities("ingot");
        needInitialise = true;
    }
