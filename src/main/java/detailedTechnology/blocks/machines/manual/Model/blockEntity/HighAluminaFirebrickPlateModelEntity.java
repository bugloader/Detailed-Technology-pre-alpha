...
public class HighAluminaFirebrickPlateModelEntity extends BlockEntity implements ImplementedInventory, NamedScreenHandlerFactory, Tickable {
    ...
    public HighAluminaFirebrickPlateModelEntity() {
        super(Manual.highAluminaFirebrickPlateModelEntity);
