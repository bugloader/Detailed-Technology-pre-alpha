...
import detailedTechnology.blocks.machines.auto.screenHandler.StoneMileScreenHandler;
...
public class StoneMileScreen extends HandledScreen<ScreenHandler> {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta){
        ...
        writeText(matrices,Integer.toString(screenHandler.getTime())+"/30 times", 41, 41);
