...
public class BronzeCombustionChamberEntity extends BlockEntity implements ImplementedInventory, NamedScreenHandlerFactory, Tickable {

    public final DefaultedList<ItemStack> inventory = DefaultedList.ofSize(1, ItemStack.EMPTY);
    public static final float breakTemperature = Materials.BRONZE.getMeltingPoint();
    public CombustionChamberUtilities utilities;

    public BronzeCombustionChamberEntity(){
        super(Auto.bronzeCombustionChamberEntity);
        utilities = new CombustionChamberUtilities(1,(Inventory)this);
    }
