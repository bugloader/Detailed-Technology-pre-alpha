...
public class SteelCombustionChamberEntity extends BlockEntity implements ImplementedInventory, NamedScreenHandlerFactory, Tickable {

    public final DefaultedList<ItemStack> inventory = DefaultedList.ofSize(1, ItemStack.EMPTY);
    public static final float breakTemperature = Materials.STEEL.getMeltingPoint();
    public CombustionChamberUtilities utilities;

    public SteelCombustionChamberEntity(){
        super(Auto.steelCombustionEntity);
        utilities = new CombustionChamberUtilities(2,(Inventory)this);
    }
