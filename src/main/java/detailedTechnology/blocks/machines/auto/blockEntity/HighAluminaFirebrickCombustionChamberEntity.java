...
public class HighAluminaFirebrickCombustionChamberEntity extends BlockEntity implements ImplementedInventory, NamedScreenHandlerFactory, Tickable {

    public final DefaultedList<ItemStack> inventory = DefaultedList.ofSize(1, ItemStack.EMPTY);
    public static final float breakTemperature = Materials.HIGH_ALUMINA_FIREBRICK.getMeltingPoint();
    public CombustionChamberUtilities utilities;

    public HighAluminaFirebrickCombustionChamberEntity(){
        super(Auto.highAluminaFirebrickCombustionChamberEntity);
        utilities = new CombustionChamberUtilities(2f,(Inventory)this);
    }
