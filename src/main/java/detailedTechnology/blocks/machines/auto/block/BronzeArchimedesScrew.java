...
public class BronzeArchimedesScrew extends HorizontalFacingBlock implements BlockEntityProvider{
    private static final VoxelShape SHAPE1 =
            Block.createCuboidShape(0, 0, 4, 16, 16, 12),
            SHAPE2 = Block.createCuboidShape(4, 0, 0, 12, 16, 16);
    public static final IntProperty WORK_PROGRESS = IntProperty.of("work",0,1);
    String material;
    public BronzeArchimedesScrew()
    {
