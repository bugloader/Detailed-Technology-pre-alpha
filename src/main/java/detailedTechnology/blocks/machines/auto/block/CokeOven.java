...
import detailedTechnology.blocks.machines.auto.blockEntity.CokeOvenEntity;
...
public class CokeOven extends HorizontalFacingBlock implements BlockEntityProvider {
    public CokeOven()
    {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof CokeOvenEntity) {
                ItemScatterer.spawn(world, pos, (CokeOvenEntity)blockEntity);
                // update comparators
