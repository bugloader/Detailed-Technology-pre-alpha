...
import detailedTechnology.blocks.machines.auto.blockEntity.StoneMileEntity;
...
public class StoneMile extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public void neighborUpdate(BlockState state, World world, BlockPos pos, Block block, BlockPos fromPos, boolean notify) {
        ...
        if(fromPos.equals(pos.up())&&
            ...
            if(blockName.equals(Manual.stoneMileRunner.getName().getString())||
                    blockName.equals(Auto.stoneMileRunnerWithGear.getName().getString())){
                ((StoneMileEntity) Objects.requireNonNull(world.getBlockEntity(pos))).increaseWorkingTime();
            }
        }
