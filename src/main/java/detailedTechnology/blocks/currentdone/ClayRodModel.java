...
import detailedTechnology.blockEntity.currentdone.ClayRodModelEntity;
...
public class ClayRodModel extends HorizontalFacingBlock implements BlockEntityProvider {
        ...
        if (!world.isClient) {
            if (player.isSneaking()) {
                ...
                if (world.getBlockState(backPos).getBlock().getName().getString().equals(
                        ...
                        ((ClayRodModelEntity) Objects.requireNonNull(world.getBlockEntity(pos))).liquidName.equals("air")) {
                    if (useTime) {
                        ((ClayRodModelEntity) Objects.requireNonNull(world.getBlockEntity(pos))).receiveUnitLiquid(
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof ClayRodModelEntity) {
                ItemScatterer.spawn(world, pos, (ClayRodModelEntity) blockEntity);
                // update comparators
