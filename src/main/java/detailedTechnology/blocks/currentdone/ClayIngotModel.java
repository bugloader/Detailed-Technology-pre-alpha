...
public class ClayIngotModel extends HorizontalFacingBlock implements BlockEntityProvider {
        ...
        if (!world.isClient) {
            if (player.isSneaking()) {
                ...
                if (world.getBlockState(backPos).getBlock().getName().getString().equals(
                        ...
                        ((ClayIngotModelEntity) Objects.requireNonNull(world.getBlockEntity(pos))).liquidName.equals("air")) {
                    if (useTime) {
                        ((ClayIngotModelEntity) Objects.requireNonNull(world.getBlockEntity(pos))).receiveUnitLiquid(
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof ClayIngotModelEntity) {
                ItemScatterer.spawn(world, pos, (ClayIngotModelEntity) blockEntity);
                // update comparators
