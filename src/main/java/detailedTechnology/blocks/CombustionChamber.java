...
import detailedTechnology.blockEntity.BronzeCombustionChamberEntity;
import detailedTechnology.blockEntity.FirebrickCombustionChamberEntity;
...
public class CombustionChamber extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof FirebrickCombustionChamberEntity) {
                ItemScatterer.spawn(world, pos, (FirebrickCombustionChamberEntity)blockEntity);
