...
public class DetailedBucketItem extends BucketItem {
                    ...
                    if (blockState.getBlock() instanceof FluidDrainable) {
                        ...
                        if (fluid != Fluids.EMPTY) {
                            ...
                            Item fullBucket = fluid.equals(Fluids.LAVA) ?
                                    (material.equals("clay") ? DetailedTechnology.clayLavaBucket : DetailedTechnology.copperLavaBucket) :
                                    (material.equals("clay") ? DetailedTechnology.clayWaterBucket : DetailedTechnology.copperWaterBucket);
    ...
    protected ItemStack getEmptiedStack(ItemStack stack, PlayerEntity player) {
        if(player.abilities.creativeMode) return stack;
            ...
            return DetailedTechnology.clayBucket.getDefaultStack();
        } else{
            return DetailedTechnology.copperBucket.getDefaultStack();
        }
    }
