...
public class DetailedBucketItem extends BucketItem {
    ...
    public DetailedBucketItem(ItemGroup itemGroup,String material,int maxStack, Fluid fluid) {
        super(fluid,new FabricItemSettings().group(itemGroup).maxCount(maxStack));
        this.fluid = fluid;
